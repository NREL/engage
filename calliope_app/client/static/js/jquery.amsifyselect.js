 ...
 * https://www.jqueryscript.net/form/dropdown-search-box-amsify-select.html
 */
	...
	AmsifySelect.prototype = {
        ...
        _init : function() {
            if(this.checkMethod()) {
                ...
                this.defaultLabel = ($(this.selector).attr('name') !== undefined) ? $(this.selector).attr('name'): "Select";
