.. Engage documentation master file, created by
   sphinx-quickstart on Tue May  5 00:12:43 2020.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to Engage's documentation!
==================================

A Calliope Web Environment for Collaborative Energy Systems Modeling and Planning
